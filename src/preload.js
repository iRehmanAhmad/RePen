...
contextBridge.exposeInMainWorld('appBridge', {
  ...
  pauseRecording: (command) => ipcRenderer.invoke('recording:pause', command),
  resumeRecording: (command) => ipcRenderer.invoke('recording:resume', command),
  stopRecording: (command) => ipcRenderer.invoke('recording:stop', command),
  cancelRecording: (command) => ipcRenderer.invoke('recording:cancel', command),
