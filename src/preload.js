...
contextBridge.exposeInMainWorld('appBridge', {
  ...
  takeScreenshot: (rect) => ipcRenderer.invoke('app:take-screenshot', rect),
  startSnipMode: () => ipcRenderer.invoke('app:start-snip-mode'),
  onStartSnipMode: (callback) => on('scene:start-snip-mode', callback),
  ...
  triggerMindmapAutoLayout: () => ipcRenderer.invoke('app:trigger-mindmap-layout'),
  onTriggerMindmapAutoLayout: (callback) => on('scene:trigger-mindmap-layout', callback),
