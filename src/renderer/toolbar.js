...
const INKING_ICONS = {
  pen: '<path d="M12 2.6 4.8 14.9 12 22l7.2-7.1L12 2.6z"/><path d="M12 6.8 8.2 15l3.8 3.7 3.8-3.7L12 6.8z" fill="#101114"/><circle cx="12" cy="14.6" r="1.6"/><path d="M12 16.2v4.3" fill="none" stroke="#101114" stroke-width="1.6" stroke-linecap="round"/>',
  highlighter: '<path d="M3.293,20.707a1,1,0,0,1,0-1.414l16-16a1,1,0,1,1,1.414,1.414l-16,16A1,1,0,0,1,3.293,20.707Z"/>',
  calligraphy: '<path d="M18.8 2.8 21.2 5.2 17 11.8l-4.8-4.8 6.6-4.2z"/><path d="M11.2 8 16 12.8 8.6 20.2 3 21l.8-5.6L11.2 8z"/><path d="M7.1 16.9 4.8 19.2l3.2-.5L7.1 16.9z" fill="#101114"/><path d="M11.2 8 16 12.8" fill="none" stroke="#101114" stroke-width="1.3" stroke-linecap="round"/>',
