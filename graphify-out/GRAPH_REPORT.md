...
## Corpus Check
- 148 files · ~116,043 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1838 nodes · 2637 edges · 151 communities (142 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 53 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bb2210d9`
...
5. `WebcamCapture` - 34 edges
6. `MFEncoder` - 32 edges
7. `DirectShowWebcamCapture` - 30 edges
8. `CaptureConfig` - 30 edges
9. `WindowRegistry` - 29 edges
...
Cohesion: 0.20
Nodes (10): build, appId, compression, directories, files, productName, win, output (+2 more)
...
Cohesion: 0.29
Nodes (7): IDXGIDevice, IInspectable, Direct3D11CaptureFramePool, HRESULT, CreateDirect3D11DeviceFromDXGIDevice(), createD3DDevice, onFrameArrived
...
Cohesion: 0.07
Nodes (10): BaseWindow, CountdownWindow, EditorWindow, createAppIcon(), loadWindowContent(), OverlayWindow, WindowRegistry, SelectorWindow (+2 more)
...
Cohesion: 0.14
Nodes (17): BIN_DIR, BUILD_DIR, CMAKE_EXE, COMPAT_LIB_DIR, findVcVarsAll(), findWindowsSdkUmLibDir(), fs, main() (+9 more)
...
Cohesion: 0.12
Nodes (16): Impl, PixelFormat, DirectShowWebcamCapture, frameMutex_, latestFrame_, latestFrameSequence_, pixelFormat_, selectedDeviceName_ (+8 more)
...
Cohesion: 0.17
Nodes (11): BoardSnapshot, BoardViewport, CaptureSourceDescriptor, CursorTrack, EditorState, PresentationEvent, PresentationTrack, RePenRecordingProjectV1 (+3 more)

### Community 112 - "devDependencies"
Cohesion: 0.18
Nodes (11): devDependencies, electron, happy-dom, react, react-dom, @types/react, @types/react-dom, typescript (+3 more)
...
### Community 116 - "main"
Cohesion: 0.13
Nodes (22): fps, height, width, BYTE, vector, hasVisibleBgraContent(), main(), FrameCallback (+14 more)

### Community 117 - "getAppState"
Cohesion: 0.48
Nodes (7): getAppState(), getDockSide(), nextPage(), normalizeBoardViewport(), prevPage(), setBoardViewport(), setPage()
...
Cohesion: 0.19
Nodes (19): atomic, condition_variable, mutex, thread, vector, HWND, string, wstring (+11 more)
...
Cohesion: 0.11
Nodes (24): AspectRatio, DEFAULT_CURSOR_SETTINGS, DEFAULT_EDITOR_APPEARANCE_SETTINGS, DEFAULT_EDITOR_LAYOUT_SETTINGS, DEFAULT_EXPORT_SETTINGS, DEFAULT_GIF_OUTPUT_DIMENSIONS, DEFAULT_GIF_SETTINGS, DEFAULT_SOURCE_DIMENSIONS (+16 more)

### Community 144 - "projectPersistence.ts"
Cohesion: 0.14
Nodes (22): clamp(), EditorProjectData, fromFileUrl(), isFiniteNumber(), migrateProjectData(), normalizeBlurColor(), normalizeBlurType(), normalizeCursorThemeId() (+14 more)
...
## Knowledge Gaps
- **912 isolated node(s):** `Point`, `BoardViewport`, `SceneAnnotation`, `PresentationTrackEvent`, `RecorderOptions` (+907 more)
...
- **Why does `main()` connect `main` to `WebcamCapture`, `WasapiLoopbackCapture`, `wasapi_loopback_capture.cpp`, `monitor_utils.cpp`, `WebcamFrameSnapshot`, `resolveInputFormat`, `AudioMixer`, `MFEncoder`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `AudioMixer` connect `AudioMixer` to `resolveInputFormat`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `DirectShowWebcamCapture` connect `DirectShowWebcamCapture` to `WebcamCapture`, `impl_`, `dshow_webcam_capture.cpp`, `initialize`, `WebcamFrameSnapshot`, `resolveInputFormat`?**
