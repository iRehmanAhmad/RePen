...
## Corpus Check
- 265 files · ~180,921 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2652 nodes · 4024 edges · 227 communities (214 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aa1baa66`
...
- [[_COMMUNITY_Drawing tools blocked by screenshot overlay|Drawing tools blocked by screenshot overlay]]
- [[_COMMUNITY_Infinite Board Pan, Zoom, and Wide PDF Export|Infinite Board Pan, Zoom, and Wide PDF Export]]
- [[_COMMUNITY_Toolbar About Panel|Toolbar About Panel]]
- [[_COMMUNITY_Settings Panel Window Clipping|Settings Panel Window Clipping]]
- [[_COMMUNITY_Calligraphy color and brand icon polish|Calligraphy color and brand icon polish]]
- [[_COMMUNITY_Multipage whiteboard PDF export|Multipage whiteboard PDF export]]
- [[_COMMUNITY_Bottom Color Grid|Bottom Color Grid]]
- [[_COMMUNITY_Markury-Style Settings Extraction|Markury-Style Settings Extraction]]
- [[_COMMUNITY_Adjust bottom color grid to 3x2 with flyout|Adjust bottom color grid to 3x2 with flyout]]
- [[_COMMUNITY_19. Security Model|19. Security Model]]
- [[_COMMUNITY_20260711-181000 Tray Cursor Settings Polish|20260711-181000 Tray Cursor Settings Polish]]
- [[_COMMUNITY_selector.js|selector.js]]
...
- [[_COMMUNITY_AudioMixer|AudioMixer]]
- [[_COMMUNITY_MFEncoder|MFEncoder]]
- [[_COMMUNITY_WgcSession|WgcSession]]
- [[_COMMUNITY_Integrate full OpenScreen feature set into RePen|Integrate full OpenScreen feature set into RePen]]
- [[_COMMUNITY_main.ts|main.ts]]
- [[_COMMUNITY_WebcamCapture|WebcamCapture]]
- [[_COMMUNITY_WasapiLoopbackCapture|WasapiLoopbackCapture]]
- [[_COMMUNITY_CaptureConfig|CaptureConfig]]
- [[_COMMUNITY_build-native-helper.js|build-native-helper.js]]
- [[_COMMUNITY_compilerOptions|compilerOptions]]
- [[_COMMUNITY_impl_|impl_]]
- [[_COMMUNITY_DirectShowWebcamCapture|DirectShowWebcamCapture]]
- [[_COMMUNITY_scripts|scripts]]
- [[_COMMUNITY_wasapi_loopback_capture.cpp|wasapi_loopback_capture.cpp]]
- [[_COMMUNITY_monitor_utils.cpp|monitor_utils.cpp]]
- [[_COMMUNITY_RePen GitHub Launch Polish|RePen GitHub Launch Polish]]
- [[_COMMUNITY_RePen Release Assets Template|RePen Release Assets Template]]
- [[_COMMUNITY_dshow_webcam_capture.cpp|dshow_webcam_capture.cpp]]
- [[_COMMUNITY_package.json|package.json]]
- [[_COMMUNITY_project.ts|project.ts]]
- [[_COMMUNITY_devDependencies|devDependencies]]
- [[_COMMUNITY_compilerOptions|compilerOptions]]
- [[_COMMUNITY_initialize|initialize]]
- [[_COMMUNITY_WebcamFrameSnapshot|WebcamFrameSnapshot]]
- [[_COMMUNITY_main|main]]
- [[_COMMUNITY_getAppState|getAppState]]
- [[_COMMUNITY_ipc.ts|ipc.ts]]
- [[_COMMUNITY_Third-Party Source Notice OpenScreen|Third-Party Source Notice: OpenScreen]]
- [[_COMMUNITY_resolveInputFormat|resolveInputFormat]]
- [[_COMMUNITY_Editor workspace density and preview fit|Editor workspace density and preview fit]]
...
- [[_COMMUNITY_projectFile.test.ts|projectFile.test.ts]]
- [[_COMMUNITY_projectPersistence.ts|projectPersistence.ts]]
- [[_COMMUNITY_syncPageStore|syncPageStore]]
- [[_COMMUNITY_init|init]]
- [[_COMMUNITY_find_extension.js|find_extension.js]]
- [[_COMMUNITY_find_openscreen_persistence.js|find_openscreen_persistence.js]]
- [[_COMMUNITY_view_load_project.js|view_load_project.js]]
- [[_COMMUNITY_view_save_project.js|view_save_project.js]]
- [[_COMMUNITY_PlaybackCoordinator|PlaybackCoordinator]]
- [[_COMMUNITY_find_pixi_init.js|find_pixi_init.js]]
...
- [[_COMMUNITY_Phase 2 — Hardware recording validation and resilience|Phase 2 — Hardware recording validation and resilience]]
- [[_COMMUNITY_Phase 6 — Offline captions|Phase 6 — Offline captions]]
- [[_COMMUNITY_Phase 7 — MP4GIF export pipeline|Phase 7 — MP4/GIF export pipeline]]
- [[_COMMUNITY_extract_launch_window.js|extract_launch_window.js]]
- [[_COMMUNITY_extract_openscreen_windows.js|extract_openscreen_windows.js]]
- [[_COMMUNITY_find_capturer.js|find_capturer.js]]
- [[_COMMUNITY_find_main_js_global_windows.js|find_main_js_global_windows.js]]
- [[_COMMUNITY_find_main_js_imports.js|find_main_js_imports.js]]
- [[_COMMUNITY_find_openscreen_selector.js|find_openscreen_selector.js]]
- [[_COMMUNITY_find_openscreen_windows.js|find_openscreen_windows.js]]
- [[_COMMUNITY_find_recording_ipc.js|find_recording_ipc.js]]
- [[_COMMUNITY_find_toolbar_record.js|find_toolbar_record.js]]
- [[_COMMUNITY_find_tsx_refs.js|find_tsx_refs.js]]
- [[_COMMUNITY_view_capturer_context.js|view_capturer_context.js]]
- [[_COMMUNITY_recordingToolbar.test.ts|recordingToolbar.test.ts]]
...
- [[_COMMUNITY_timelineEdits.ts|timelineEdits.ts]]
...
- [[_COMMUNITY_3. Manual Lifecycle Test Matrix (Windows 11)|3. Manual Lifecycle Test Matrix (Windows 11)]]
...
- [[_COMMUNITY_19. Security Model|19. Security Model]]
- [[_COMMUNITY_TimelineTracks.tsx|TimelineTracks.tsx]]
- [[_COMMUNITY_getAppState|getAppState]]
- [[_COMMUNITY_wgc_session.cpp|wgc_session.cpp]]
- [[_COMMUNITY_EditorHeader.tsx|EditorHeader.tsx]]
...
- [[_COMMUNITY_useProjectManager.ts|useProjectManager.ts]]
...
- [[_COMMUNITY_Editor stage and density correction|Editor stage and density correction]]

## God Nodes (most connected - your core abstractions)
1. `main()` - 39 edges
2. `WgcSession` - 38 edges
3. `RecorderService` - 37 edges
4. `WasapiLoopbackCapture` - 37 edges
5. `AudioMixer` - 36 edges
6. `WebcamCapture` - 35 edges
7. `MFEncoder` - 32 edges
8. `DirectShowWebcamCapture` - 31 edges
9. `CaptureConfig` - 30 edges
...
- `bootstrap()` --calls--> `isTrustedRecordingSender()`  [INFERRED]
  electron/main.ts → main.js
- `EditorApp()` --calls--> `bootstrap()`  [INFERRED]
  src/renderer/editor.tsx → electron/main.ts
- `createProjectForCompletedRecording()` --calls--> `createRecordingProject()`  [INFERRED]
  main.js → src/shared/editor/projectFactory.js
- `useAppBridge()` --indirect_call--> `options()`  [INFERRED]
  src/renderer/editor/useAppBridge.ts → tests/unit/recorder.test.ts
...
Cohesion: 0.10
Nodes (44): bootstrapApp(), cancelScreenshotMode(), canDraw(), canvas, checkAutoAdvance(), clearSelection(), clickRipples, createStrokeFromEvent() (+36 more)

### Community 4 - "toolbar.js"
Cohesion: 0.07
Nodes (45): activateToolbarSettingsTab(), appContainer, appState, closeAllPopovers(), collectToolbarSettingsDraft(), COLORS, currentBrushValue(), elements (+37 more)

### Community 5 - "package.json"
Cohesion: 0.17
Nodes (12): build, appId, asarUnpack, compression, directories, extraResources, files, productName (+4 more)
...
### Community 69 - "19. Security Model"
Cohesion: 0.17
Nodes (11): Acceptance Checks, Constraints, Context Read, Current Phase, Fix screenshot double taskbar alignment and lifecycle, Goal, Handoff Notes, Owners (+3 more)
...
### Community 71 - "Drawing tools blocked by screenshot overlay"
Cohesion: 0.25
Nodes (7): Analysis, Current Phase, Drawing tools blocked by screenshot overlay, Goal, Handoff, Plan, Verification

### Community 72 - "Infinite Board Pan, Zoom, and Wide PDF Export"
Cohesion: 0.25
Nodes (7): Analysis, Handoff, Infinite Board Pan, Zoom, and Wide PDF Export, Intake, Plan, Status, Verification

### Community 73 - "Toolbar About Panel"
Cohesion: 0.29
Nodes (6): Analysis, Implementation, Intake, Status, Toolbar About Panel, Verification

### Community 74 - "Settings Panel Window Clipping"
Cohesion: 0.29
Nodes (6): Analysis, Implementation, Intake, Settings Panel Window Clipping, Status, Verification

### Community 75 - "Calligraphy color and brand icon polish"
Cohesion: 0.33
Nodes (5): Calligraphy color and brand icon polish, Changes, Current Phase, Goal, Verification

### Community 76 - "Multipage whiteboard PDF export"
Cohesion: 0.33
Nodes (5): Changes, Current Phase, Goal, Multipage whiteboard PDF export, Verification

### Community 77 - "Bottom Color Grid"
Cohesion: 0.33
Nodes (5): Bottom Color Grid, Implementation, Intake, Status, Verification

### Community 78 - "Markury-Style Settings Extraction"
Cohesion: 0.33
Nodes (5): Implementation, Intake, Markury-Style Settings Extraction, Status, Verification

### Community 79 - "Adjust bottom color grid to 3x2 with flyout"
Cohesion: 0.17
Nodes (11): Acceptance Checks, Adjust bottom color grid to 3x2 with flyout, Constraints, Context Read, Current Phase, Goal, Handoff Notes, Owners (+3 more)

### Community 80 - "19. Security Model"
Cohesion: 0.17
Nodes (11): Acceptance Checks, Constraints, Context Read, Current Phase, Goal, Handoff Notes, Owners, Plan (+3 more)

### Community 81 - "20260711-181000 Tray Cursor Settings Polish"
Cohesion: 0.29
Nodes (6): 20260711-181000 Tray Cursor Settings Polish, Analysis, Handoff, Intake, Plan, Verification

### Community 82 - "selector.js"
Cohesion: 0.25
...
Cohesion: 0.16
Nodes (19): broadcastRecordingState(), broadcastRecordingTimer(), getPresentationSceneSnapshot(), handleCancelRecording(), handlePauseRecording(), handlePauseRecordingShortcut(), handleRecordingFailure(), handleRestartRecording() (+11 more)
...
Cohesion: 0.15
Nodes (22): applyCapturePolicy(), createAppIcon(), createCountdownWindow(), createEditorWindow(), createOverlayWindow(), createOverlayWindows(), createSelectorWindow(), createSettingsWindow() (+14 more)
...
Cohesion: 0.06
Nodes (16): appendRendererDebugLog(), writeQueue, BaseWindow, isTrustedNavigation(), CountdownWindow, EditorWindow, createAppIcon(), configuredDevServerUrl (+8 more)
...
Cohesion: 0.18
Nodes (17): BIN_DIR, BUILD_DIR, findBuildTools(), findBuiltBinary(), findOnPath(), findVisualStudioRoot(), firstExisting(), fs (+9 more)
...
### Community 102 - "impl_"
Cohesion: 0.12
Nodes (16): IBaseFilter, ICaptureGraphBuilder2, IGraphBuilder, IMediaControl, ISampleGrabber, ComPtr, impl_, captureFilter (+8 more)

### Community 103 - "DirectShowWebcamCapture"
Cohesion: 0.12
Nodes (17): Impl, PixelFormat, DirectShowWebcamCapture, frameMutex_, latestFrame_, latestFrameSequence_, latestFrameTimestampHns_, pixelFormat_ (+9 more)

### Community 104 - "scripts"
Cohesion: 0.10
Nodes (20): scripts, agent, build:all, dev, dist, electron:build, graphify:update, native:build (+12 more)

### Community 105 - "wasapi_loopback_capture.cpp"
Cohesion: 0.12
Nodes (15): duration, function, CaptureControl, cancelRequested, cv, mutex, paused, pauseStartedAt (+7 more)

### Community 106 - "monitor_utils.cpp"
Cohesion: 0.27
Nodes (11): RECT, HMONITOR, MonitorBounds, vector, enumerateMonitors(), findMonitorForCapture(), MonitorCandidate, monitor (+3 more)

### Community 107 - "RePen GitHub Launch Polish"
Cohesion: 0.17
Nodes (11): Acceptance Checks, Constraints, Context Read, Current Phase, Goal, Handoff Notes, Owners, Plan (+3 more)

### Community 108 - "RePen Release Assets Template"
Cohesion: 0.17
Nodes (11): Acceptance Checks, Constraints, Context Read, Current Phase, Goal, Handoff Notes, Owners, Plan (+3 more)

### Community 109 - "dshow_webcam_capture.cpp"
Cohesion: 0.26
...
Cohesion: 0.18
Nodes (10): compilerOptions, esModuleInterop, module, outDir, resolveJsonModule, rootDir, skipLibCheck, strict (+2 more)

### Community 114 - "initialize"
Cohesion: 0.07
Nodes (28): Case 1.1: Baked Display Capture (100% Display Scaling), Case 1.2: Baked Display Capture (150% Display Scaling), Case 1.3: Sidecar Selected-Window Capture (100% Display Scaling), Case 1.4: Sidecar Selected-Window Capture (150% Display Scaling), Case 2.1: Baked Display Capture (100% Display Scaling), Case 2.2: Baked Display Capture (150% Display Scaling), Case 2.3: Sidecar Selected-Window Capture (100% Display Scaling), Case 2.4: Sidecar Selected-Window Capture (150% Display Scaling) (+20 more)

### Community 115 - "WebcamFrameSnapshot"
Cohesion: 0.20
Nodes (10): copyLatestFrame, BYTE, vector, WebcamFrameSnapshot, data, height, sequence, timestampHns (+2 more)

### Community 116 - "main"
Cohesion: 0.11
Nodes (32): DEFAULT_CURSOR_SETTINGS, DEFAULT_EDITOR_APPEARANCE_SETTINGS, DEFAULT_EDITOR_LAYOUT_SETTINGS, DEFAULT_EXPORT_SETTINGS, DEFAULT_GIF_OUTPUT_DIMENSIONS, DEFAULT_GIF_SETTINGS, DEFAULT_SOURCE_DIMENSIONS, ExportFormat (+24 more)
...
Cohesion: 0.12
Nodes (22): CaptionsPanelProps, EditorHeader(), EditorHeaderProps, getBridge(), RawBridge, useAppBridge(), unavailableCapabilities(), useCapabilities() (+14 more)
...
### Community 121 - "Editor workspace density and preview fit"
Cohesion: 0.29
Nodes (6): Analysis, Editor workspace density and preview fit, Implementation plan, Intake, Result, Verification
...
Cohesion: 0.07
Nodes (26): BoardSnapshot, BoardViewport, defaultWriterFactory, parsePresentationTrackJsonl(), Point, PRESENTATION_TRACK_SCHEMA_VERSION, PresentationBounds, PresentationCanvasMetadata (+18 more)
...
Cohesion: 0.06
Nodes (29): AnnotationPosition, AnnotationSize, AnnotationTextAnimation, AnnotationTextStyle, AnnotationType, ArrowDirection, BlurColor, BlurData (+21 more)
...
Cohesion: 0.13
Nodes (20): broadcastState(), captureMagnifierBackground(), cycleBackgroundMode(), ensureToolbarWindowCapacity(), getToolbarWindowBounds(), quitApp(), setBackgroundMode(), setClickHalo() (+12 more)

### Community 145 - "syncPageStore"
Cohesion: 0.29
Nodes (7): Cursor and click effects, Exit gate, Layout and background, Motion and focus, Phase 5 — Visual editing and compositor parity, Tests, Webcam and annotations

### Community 146 - "init"
Cohesion: 0.40
Nodes (5): Engineering, Exit gate, Phase 9 — Windows release hardening, Platform matrix, Rollout

### Community 147 - "find_extension.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 148 - "find_openscreen_persistence.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 149 - "view_load_project.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 150 - "view_save_project.js"
Cohesion: 0.50
Nodes (3): content, fs, lines
...
### Community 153 - "read_pixi_setup.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 154 - "read_videoplayback.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 155 - "view_pixi_init.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 156 - "find_main_cpp_source_type.js"
Cohesion: 0.50
Nodes (4): Architecture, Exit gate, Implementation, Phase 4 — Editor and project foundation
...
Cohesion: 0.50
Nodes (4): Exit gate, Implementation, Phase 1 — Recorder setup and source selection, Tests

### Community 160 - "Phase 2 — Hardware recording validation and resilience"
Cohesion: 0.50
Nodes (4): Exit gate, Implementation corrections allowed in this phase, Phase 2 — Hardware recording validation and resilience, Validation matrix

### Community 161 - "Phase 6 — Offline captions"
Cohesion: 0.50
Nodes (4): Exit gate, Implementation, Phase 6 — Offline captions, Product decision required before implementation

### Community 162 - "Phase 7 — MP4/GIF export pipeline"
Cohesion: 0.50
Nodes (4): Exit gate, Implementation, Phase 7 — MP4/GIF export pipeline, Validation

### Community 163 - "extract_launch_window.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 164 - "extract_openscreen_windows.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 165 - "find_capturer.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 166 - "find_main_js_global_windows.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 167 - "find_main_js_imports.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 170 - "find_recording_ipc.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 171 - "find_toolbar_record.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 173 - "view_capturer_context.js"
Cohesion: 0.50
Nodes (3): content, fs, lines

### Community 174 - "recordingToolbar.test.ts"
Cohesion: 0.50
Nodes (3): mainSource, projectRoot, toolbarSource

### Community 175 - "Phase 3 — Recording session UX and recovery"
Cohesion: 0.67
Nodes (3): Exit gate, Implementation, Phase 3 — Recording session UX and recovery

### Community 176 - "Phase 8 — Product completeness"
Cohesion: 0.67
...
Cohesion: 0.20
Nodes (10): AM_MEDIA_TYPE, GUID, HRESULT, string, wstring, initialize, start, freeMediaType() (+2 more)
...
Cohesion: 0.16
Nodes (25): EDITOR_TABS, EditorApp(), EditorLocale, EditorTab, isEditorLocale(), rootEl, TRANSLATIONS, addSpeedRange() (+17 more)
...
### Community 192 - "timelineEdits.ts"
Cohesion: 0.15
...
Cohesion: 0.33
Nodes (7): validateActiveRecordingCommand(), canRunRecordingCommand(), COMMAND_PHASES, recordingCommandError(), RecordingPhase, validateRecordingCommand(), { RecordingPhase, canRunRecordingCommand, recordingCommandError, validateRecordingCommand }

### Community 205 - "Capture Policy Decision"
Cohesion: 0.67
Nodes (3): Always excluded from capture, Capture Policy Decision, Presentation content

### Community 206 - "3. Manual Lifecycle Test Matrix (Windows 11)"
Cohesion: 0.18
...
Cohesion: 0.16
Nodes (17): AnnotationsPanel(), AnnotationsPanelProps, CaptionsPanel(), CompositorPreviewProps, CompactRangeRowProps, LayoutPanel(), LayoutPanelProps, MotionPanel() (+9 more)
...
### Community 221 - "visualCompositor.ts"
Cohesion: 0.14
Nodes (17): CompositorPreview(), toFileUrl(), usePreviewViewport(), UsePreviewViewportProps, ZoomMode, AspectRatio, ASPECT_RATIO_CSS, aspectRatioCss() (+9 more)

### Community 222 - "useProjectManager.ts"
Cohesion: 0.19
Nodes (8): useProjectManager(), clearRecoverySnapshot(), readRecoverySnapshot(), recoveryKey(), RecoverySnapshot, RecoveryStorage, saveRecoverySnapshot(), MemoryStorage

### Community 223 - "Editor playback and workspace upgrade"
Cohesion: 0.33
Nodes (5): Editor playback and workspace upgrade, Intake, Plan, Result, Verification

### Community 224 - "EditorHeader.tsx"
Cohesion: 0.25
Nodes (7): Acceptance criteria, Analysis, Editor workspace rearchitecture, Intake, Plan, Status, Verification

### Community 225 - "timelineMath.ts"
Cohesion: 0.47
Nodes (4): annotationId(), applyPresentationEvent(), clone(), replayPresentationTrack()

### Community 226 - "Editor stage and density correction"
Cohesion: 0.33
Nodes (5): Editor stage and density correction, Implementation, Intake, Result, Root causes

## Knowledge Gaps
- **1222 isolated node(s):** `{ createAppCapabilities }`, `lastEnumeratedSources`, `approvedRecordingDirectories`, `writeQueue`, `PRESENTATION_TRACK_SCHEMA_VERSION` (+1217 more)
...
- **Why does `EditorApp()` connect `editor.tsx` to `main.ts`, `project.ts`, `init`, `ipc.ts`, `EditorHeader.tsx`, `PlaybackCoordinator`, `useProjectManager.ts`?**
